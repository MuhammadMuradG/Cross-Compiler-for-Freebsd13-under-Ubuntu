...
cd binutils-2.36
./configure --with-sysroot=~/Cross-Compiler-for-Freebsd13-under-Ubuntu/base/ --enable-libssp --enable-gold --enable-ld --target=x86_64-unknown-freebsd13 --prefix=/usr/cross-freebsd
gmake
gmake install
